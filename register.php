...
<body>
    <div class="bg-[#ffd700] w-full h-[100vh] flex items-center justify-center p-4">
        ...
        <form class="lg:w-1/2 w-full p-4 rounded-xl bg-white" method="post">
            <h1 class="text-4xl font-bold mb-8">Register Please</h1>

            <div class="mb-5">
                <label for="nama" class="block mb-2 text-lg font-medium text-gray-900">Masukkan nama
                   </label>
                <input type="text" id="nama"
                    ...
                    placeholder="name@flowbite.com" name="nama" required />
            </div>
            ...
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="submit">Register
                new account</button>
        </form>
